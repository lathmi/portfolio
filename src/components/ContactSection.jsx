        ...
        > 
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
                    ...
                    <div className="bg-card hover:bg-primary/20 p-8 rounded-lg shadow-xs"> 
                        <h3 className="text-2xl font-semibold mb-6"> Send a Message</h3>
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div>
                                <label htmlFor="name" className="block text-sm font-medium mb-2 font-cormorant scale-y-100 italic"> 
                                    Your Name
                                </label>
                                <input 
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="email" className="block text-sm font-medium mb-2 font-cormorant scale-y-100 italic"> 
                                    Email
                                </label>
                                <input 
                                    type="email"
                            ...
                            <div>
                                <label htmlFor="message" className="block text-sm font-medium mb-2 font-cormorant scale-y-100 italic"> 
                                    Message
                                </label>
                                <textarea 
                                    id="message"
